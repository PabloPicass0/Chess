...
ChessBoard.o: ChessBoard.cpp color.h pieceType.h ChessBoard.h ChessPieces.h
	g++ -c -g -Wall ChessBoard.cpp

ChessPieces.o: ChessPieces.cpp color.h pieceType.h ChessPieces.h ChessBoard.h
